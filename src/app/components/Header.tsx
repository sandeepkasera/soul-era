...
const Header = () => {
  ...
  return (
    <header className="bg-purple-color text-white py-4 shadow-lg">
        ...
        <ul className={`md:flex md:items-center md:space-x-6 ${isMenuOpen ? 'block' : 'hidden'} absolute md:relative top-16 md:top-auto left-0 w-full md:w-auto bg-gray-800 md:bg-transparent z-10 md:z-auto transition-all duration-300 ease-in-out`}>
          ...
          <li className="p-4 md:p-0 md:mx-2 hover:text-gray-300">
            <form action="#" method="GET" className="flex items-center w-full">
              ...
              <button type="submit" onClick={searchProducts} className="text-gray-900 bg-purple-700 border border-purple-950 focus:outline-none hover:bg-purple-900 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 ml-2 dark:text-white dark:border-gray-600 dark:focus:ring-gray-700">
                Search
              </button>
            </form>
          </li>
